...
{
    /*
    public class DatagramPacketBufferManager
    {
        ...
        public DatagramPacketBufferManager(int totalBytes, int buffSize)
        {
            numBytes = totalBytes;
            currentIndex = 0;
            bufferSize = buffSize;
        ...
        public bool SetBuffer(DatagramPacket args)
        {
        ...
        public void FreeBuffer(DatagramPacket args)
        {
